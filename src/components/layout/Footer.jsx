                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 text-center md:text-left">
                    ...
                    <div>
                        ...
                        <div className="flex justify-center md:justify-start space-x-4">
                            <a href="#" className="text-gray-500 hover:text-orange-500 cursor-pointer" aria-label="Facebook">
                                <FaFacebook className="w-6 h-6" />
                            </a>
                            <a href="#" className="text-gray-500 hover:text-orange-500 cursor-pointer" aria-label="Twitter">
                                <FaTwitter className="w-6 h-6" />
                            </a>
                            <a href="#" className="text-gray-500 hover:text-orange-500 cursor-pointer" aria-label="Instagram">
                                <FaInstagram className="w-6 h-6" />
                            </a>
                            <a href="#" className="text-gray-500 hover:text-orange-500 cursor-pointer" aria-label="LinkedIn">
